...
public class Tutorial : MonoBehaviour {
    ...
    string[] TutorialStartMessages = new string[] {
        ...
        "Great work, you killed it again! Now your hand has some more cards from other Gods. They seem pretty boring but maybe you'll find a use for them. Just tap any card twice.", //level 6
        "If you need to know what a card does, try holding it down to show you what the full card looks like. \n\nThat should be enough to get you started. I'll be watching over you, " + 
        "and if you do well enough, other Gods will lend you their power too. Best of luck." //Level 7
    };
