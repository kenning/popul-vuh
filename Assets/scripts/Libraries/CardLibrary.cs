...
//		                                    Card.CardActionTypes.NoTarget));
		...
		Lib.Add("Cloth Shirt", (new LibraryCard("Cloth Shirt",
		                                        "Cloth\nShirt",
		                                          ...
		                                          Card.Rarity.Paper,
		                                          "This card will automatically discard itself to prevent damage done to you",
		...
		Lib.Add("Iron Macana", (new LibraryCard("Iron Macana",
		                                       "Iron\nMacana", 
		                                         ...
		                                         Card.CardActionTypes.TargetGridSquare, 
		                                       GridControl.TargetTypes.diamond, 1, GridControl.TargetTypes.none, 0)));
		Lib.Add ("Wooden Bow", (new LibraryCard("Wooden Bow",
		                                        "Wooden\nBow",
		                                        "pocket-bow",
		                                        ShopControl.Gods.Buluc,
		                                        Card.Rarity.Paper,
		                                        ...
		                                        "Cross range 6,\n1 damage",
		                                        Card.CardActionTypes.TargetGridSquare,
		                                        GridControl.TargetTypes.cross, 6, GridControl.TargetTypes.none, 0)));
		//Unlockable
