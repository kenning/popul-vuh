...
//	public Sprite ERRORSPRITE;
    ...
    bool sickCheck()
    {
        ...
        if (ThisSickType == GameControl.SickTypes.Bleeding && battleBoss.BleedingTurns > 0) return true;
        if (ThisSickType == GameControl.SickTypes.Swollen && battleBoss.SwollenTurns > 0) return true;
        if (ThisSickType == GameControl.SickTypes.Hunger && battleBoss.SwollenTurns > 0) return true;
	...
	public void SetSprite () {
        bool Empty = battleBoss.PlaysLeft < 1;
        if (gameObject.name == "move end button") Empty = battleBoss.MovesLeft < 1;
        SetSprite(Empty);
	}
