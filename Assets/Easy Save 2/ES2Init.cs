...
public class ES2Init : MonoBehaviour
{
	...
	public static void Init()
	{
		...
		ES2TypeManager.types[typeof(Goal)] = new ES2UserType_Goal();
		ES2TypeManager.types[typeof(LibraryCard)] = new ES2UserType_LibraryCard();
		ES2TypeManager.types[typeof(SavedGame)] = new ES2UserType_SavedGame();
		ES2TypeManager.types[typeof(SavedState)] = new ES2UserType_SavedState();
